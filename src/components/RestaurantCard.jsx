        ...
        <Link to={`/restaurant/${id}`} className="block w-full">
            <div className="card-hover p-4 rounded-2xl bg-white hover:shadow-xl transition-all duration-300 border border-transparent hover:border-gray-100">
                <div className="relative h-48 w-full overflow-hidden rounded-2xl">
                    <img
                        src={imageUrl || "https://b.zmtcdn.com/data/pictures/chains/1/50691/11d0b1359c2b9a7000d6B00c61.jpg"}
                        alt={name}
                ...
                <div className="mt-3">
                    <div className="flex justify-between items-start">
                        ...
                        <div className={`flex items-center space-x-1 px-1.5 py-0.5 rounded text-white text-xs font-bold ${rating >= 4.0 ? 'bg-green-600' : 'bg-orange-500'}`}>
                            <span>{rating}</span>
                            <FaStar size={10} />
                        </div>
                    </div>
